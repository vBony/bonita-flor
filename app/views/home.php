...
<html lang="en">
   ...
   <body class="main-layout">
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo">
                              <a href="index.html"><img src="<?=BASE_URL?>/app/assets/images/logo.png" alt="#" /></a>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="container-fluid">
                     <div class="carousel-caption relative">
                        <div class="row d_flex">
                           <div class="col-md-6">
                              <img class="bann_img" src="<?=BASE_URL?>/app/assets/images/banner_ing.jpg" alt="#"/>
                           </div>
                           <div class="col-md-6">
                              <span>01/03</span>
               ...
               <div class="col-lg-8 offset-lg-2 col-md-12">
                  <div class="row">
                     <div class="col-md-4">
                        <div id="exp" class="experts_box">
                           <div class="experts_img">
                              <figure><img src="<?=BASE_URL?>/app/assets/images/blog1.jpg" alt="#"/></figure>
                           </div>
                           <div class="meet">
                              <h3>Jacob</h3>
                              <p>Lorem ipsum dolor sit amet, iscing elit, sed do magna </p>
                     ...
                     <div class="col-md-4">
                        <div id="exp" class="experts_box">
                           <div class="experts_img">
                              <figure><img src="<?=BASE_URL?>/app/assets/images/blog2.jpg" alt="#"/></figure>
                           </div>
                           <div class="meet">
                              <h3>Lonut</h3>
                              <p>Lorem ipsum dolor sit amet, iscing elit, sed do magna</p>
                     ...
                     <div class="col-md-4">
                        <div id="exp" class="experts_box">
                           <div class="experts_img">
                              <figure><img src="<?=BASE_URL?>/app/assets/images/blog3.jpg" alt="#"/></figure>
                           </div>
                           <div class="meet">
                              <h3>Irina</h3>
                              <p>Lorem ipsum dolor sit amet, iscing elit, sed do magna</p>
      ...
      <!-- sidebar -->
      <script src="<?=BASE_URL?>app/assets/js/jquery.mCustomScrollbar.concat.min.js"></script>
      <script src="<?=BASE_URL?>app/assets/js/custom.js"></script>
   </body>
</html>
